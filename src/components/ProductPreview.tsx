    ...
    return (
        <div className='flex flex-col font-RedHat'>
            <div className='relative flex justify-center items-center'>
                ...
                {isSelected ? (
                    <div className='px-5 flex z-2 items-center justify-between absolute bottom-0 bg-customRed w-[160px] rounded-full h-[44px]'>
                    ...
                    <button onClick={() => handleIncrementProductAmount(product)} className='gap-1 flex z-2 absolute border-customRed border-[1px] bottom-0 bg-white w-[160px] rounded-full h-[44px] justify-center items-center'>
